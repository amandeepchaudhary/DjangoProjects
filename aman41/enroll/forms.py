...
class  studentform(forms.ModelForm):
    name = forms.CharField(max_length=30)  # Validators in ModelForm same as the Form API and this is a high priority and after this it takes from here and continue further down
    class Meta:
